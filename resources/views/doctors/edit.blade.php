...
@section('content')
    ...
    <head>
        ...
        <style>
            ...
            .card-header::before {
                ...
                right: 0;
                bottom: 0;
                background: url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M11 18c3.866 0 7-3.134 7-7s-3.134-7-7-7-7 3.134-7 7 3.134 7 7 7zm48 25c3.866 0 7-3.134 7-7s-3.134-7-7-7-7 3.134-7 7 3.134 7 7 7zm-43-7c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm63 31c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zM34 90c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm56-76c1.657 0 3-1.343 3-3s-3.134-7-7-7-7 3.134-7 7 3.134 7 7 7zm-9-21c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM60 91c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM35 41c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM12 60c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2z' fill='%23ffffff' fill-opacity='0.1' fill-rule='evenodd'/%3E%3C/svg%3E");
                opacity: 0.3;
            }
    ...
    <div class="container edit-user-container">
        <div class="user-card">
            <div class="card-header text-center">
                ...
                <h3>{{ __('messages.edit_doctor') ?? 'Edit Doctor' }}</h3>
            </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('doctors.update', $doctor->id) }}" id="editDoctorForm">
                    ...
                    <div class="form-section">
                        ...
                        <div class="language-content active" id="name-ar">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('name_ar') is-invalid @enderror"
                                    id="name_ar" name="name_ar" value="{{ old('name_ar', $doctor->name['ar'] ?? '') }}"
                        ...
                        <div class="language-content" id="name-en">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('name_en') is-invalid @enderror"
                                    id="name_en" name="name_en" value="{{ old('name_en', $doctor->name['en'] ?? '') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('specialization') is-invalid @enderror"
                                        ...
                                        placeholder="{{ __('Specialization') }}" required>
                        ...
                        <div class="form-floating">
                            <input type="tel" class="form-control @error('whatsapp') is-invalid @enderror"
                                id="whatsapp" name="whatsapp" value="{{ old('whatsapp', $doctor->whatsapp) }}"
                                placeholder="{{ __('WhatsApp Number') }}">
                            <label for="whatsapp">{{ __('WhatsApp Number') }}</label>
                            <div class="form-text">{{ __('Optional WhatsApp contact number') }}</div>
                            @error('whatsapp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <button type="submit" class="btn btn-submit" id="submitBtn">
                        ...
                        <span>{{ __('messages.update_doctor') ?? 'Update Doctor' }}</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editDoctorForm').on('submit', function() {
            ...
            $('#phone, #whatsapp').on('blur', function() {
                ...
                if (phone && !phoneRegex.test(phone)) {
                    $(this).addClass('is-invalid');
                    $(this).next('.invalid-feedback').text('Please enter a valid phone number.');
                }
            });
        });
    </script>
