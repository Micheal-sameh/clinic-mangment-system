...
@section('content')
    ...
    <div class="container edit-user-container">
        <div class="user-card">
            <div class="card-header text-center">
                ...
                <h3>{{ __('messages.add_doctor') ?? 'Add Doctor' }}</h3>
            </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('doctors.store') }}" id="createDoctorForm">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-submit" id="submitBtn">
                        ...
                        <span>{{ __('messages.add_doctor') ?? 'Add Doctor' }}</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createDoctorForm').on('submit', function() {
